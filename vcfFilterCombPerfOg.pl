...
## 266 inds, 2x
my $minCoverage = 532; # minimum number of sequences; DP
...
my $qd = 2; # minimum ratio of variant confidence to non reference read depth; QD
my $mq = 30; # minimum mapping quality; MQ
my $miss = 52; # maximum number of individuals with no data
##### this set is for GBS
my $d;
